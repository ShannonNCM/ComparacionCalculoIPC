...
#me falta arreglar esto para que tome los indices de las regiones, pero aun no tengo la funcion que me permite bajar los datos del indice de region del sistema
```
...
```{r}
#write.xlsx(prod_faltantes, "productosnorecolectadoss_022024.xlsx")
```
...
writeData(indices, "Cuadro16", prod_faltantes)
