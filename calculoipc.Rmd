...
bol <- boletas %>% 
  ...
  filter(cantidad_anterior-cantidad_actual < 10) %>% 
  filter(precio_anterior-precio_actual < 10) %>% 
  filter(cantidad_actual-cantidad_anterior < 10) %>% 
  filter(precio_actual-precio_anterior < 10) #%>% 
